...
# shamelessly stolen from the Arch install image 
# 2019-01-21
...
# Copyright © 2002-2018 [265]Judd Vinet and [266]Aaron Griffin. The Arch Linux name and logo are recognized trademarks. Some rights reserved. The registered
# trademark Linux is used pursuant to a sublicense from LMI, the exclusive licensee of Linus Torvalds, owner of the mark on a world-wide basis.
